...
<Library LVVersion="14008000">
	...
	<Item Name="Public" Type="Folder">
		...
		<Item Name="Configure" Type="Folder">
			...
			<Item Name="Configure Motor Speed.vi" Type="VI" URL="../Configure Motor Speed.vi"/>
			<Item Name="Configure Serial Baud Rate.vi" Type="VI" URL="../Configure Serial Baud Rate.vi"/>
			<Item Name="Configure Laser Sensitivity.vi" Type="VI" URL="../Configure Laser Sensitivity.vi"/>
		</Item>
		<Item Name="Data" Type="Folder">
			...
			<Item Name="Acquire Multi Echo .vi" Type="VI" URL="../Acquire Multi Echo .vi"/>
			<Item Name="Acquire Continuous Data.vi" Type="VI" URL="../Acquire Continuous Data.vi"/>
			<Item Name="Acquire Continuous Multi Echo Data.vi" Type="VI" URL="../Acquire Continuous Multi Echo Data.vi"/>
		</Item>
		<Item Name="Utility" Type="Folder">
			<Item Name="Utility.mnu" Type="Document" URL="/&lt;instrlib&gt;/Hokuyo URG Series/Public/Utility/Utility.mnu"/>
			<Item Name="Configure Laser Power.vi" Type="VI" URL="../Configure Laser Power.vi"/>
			<Item Name="Sensor Specification.vi" Type="VI" URL="../Sensor Specification.vi"/>
			<Item Name="Revision Query.vi" Type="VI" URL="../Revision Query.vi"/>
			<Item Name="Match Time.vi" Type="VI" URL="../Match Time.vi"/>
			<Item Name="Sensor State.vi" Type="VI" URL="../Sensor State.vi"/>
		</Item>
		<Item Name="dir.mnu" Type="Document" URL="../Public/dir.mnu"/>
		<Item Name="Close.vi" Type="VI" URL="../Close.vi"/>
		<Item Name="Initialize.vi" Type="VI" URL="../Initialize.vi"/>
		<Item Name="Initialize-Standard.vi" Type="VI" URL="../Initialize-Standard.vi"/>
		<Item Name="Initialize-cRIO-USB.vi" Type="VI" URL="../Initialize-cRIO-USB.vi"/>
	...
	<Item Name="Private" Type="Folder">
		...
		<Item Name="Set SCIP Mode.vi" Type="VI" URL="../Set SCIP Mode.vi"/>
		<Item Name="Error Query.vi" Type="VI" URL="../Error Query.vi"/>
		<Item Name="Query Instrument.vi" Type="VI" URL="../Query Instrument.vi"/>
		<Item Name="Flush.vi" Type="VI" URL="../Flush.vi"/>
		<Item Name="Query Scan Response Message.vi" Type="VI" URL="../Query Scan Response Message.vi"/>
	</Item>
